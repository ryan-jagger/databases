...
describe("Persistent Node Chat Server", function() {
  ...
  it("Should output all messages from the DB", function(done) {
    // Let's insert a message into the db
       var queryString = "INSERT INTO messages(message_text, username, roomname, created_at) VALUE(?, ?, ?, UNIX_TIMESTAMP());";
       var queryArgs = ['Men like you can never change!', 'someuser', 'main'];
